...
The linear model estimates utility vehicles increase the risk of fatality by 1.66% compared to cars, which may seem small, however when we see the shift towards larger vehicles in Australia (the top 3 best selling cars are utility vehicles), it may result in more pedestrian deaths.

The date currently has cars outweighing utility vehicles & station wagons in the number of accidents involving pedestrians. However we may see this shift to larger vehicles being more frequently involved in pedestrian accidents.
